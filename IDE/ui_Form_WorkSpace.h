...
public:
    ...
    QAction *action_toolBar_property;
...
"}"));
        ...
        action_toolBar_attestation->setIcon(icon73);
        ...
        action_toolBar_white->setIcon(icon78);
        ...
        action_toolBar_Dark->setIcon(icon78);
        ...
        toolBar->addSeparator();
        toolBar->addAction(action_toolBar_property);
...
#endif // QT_CONFIG(tooltip)
        action_toolBar_property->setText(QCoreApplication::translate("Form_WorkSpace", "\350\265\204\344\272\247", nullptr));
#if QT_CONFIG(tooltip)
        action_toolBar_property->setToolTip(QCoreApplication::translate("Form_WorkSpace", "\350\265\204\344\272\247", nullptr));
#endif // QT_CONFIG(tooltip)
